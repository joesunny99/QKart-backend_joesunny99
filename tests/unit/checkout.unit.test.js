...
describe("Cart test", () => {
  ...
  describe("Checkout", () => {
    ...
    it("should update user balance and empty the cart on success", async () => {
      let userOneFinal = { ...userOne }; //a hardcoded user that we are using for testing. Check in fixtures, what it is.
      ...
      mockingoose(Cart).toReturn(cartWithProductsUserOne, "findOne"); //when uou do Cart.findOne - it will run that function in the fixtures.
